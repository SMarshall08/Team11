<%@ Page Title="View Requests" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewRequest.aspx.cs" Inherits="Team11.ViewRequest" %>
...
<div class="canister">
    ...
    <div id="requestDetails" runat="server" style="height: 191px" visible="false">
        ...
        <div style="background-color:white; margin-top:-10px;   margin-left: auto; margin-right: auto;" class="marg canister">
            ...
            <div runat="server" id="ViewTable" style="margin-top: 0px; overflow: auto; height: 450px; width: 80%;">hello</div>
