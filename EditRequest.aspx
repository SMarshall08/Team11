<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditRequest.aspx.cs" Inherits="Team11.EditRequest" MaintainScrollPositionOnPostback = "true"%>
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            $.each([
                   ...
                   function (index, controlEdit) {
                       if ($(controlEdit).is(":checked"))
                           $(controlEdit).parent().addClass("btn btn-danger");
                   }
                   );
